...
alphablit_alpha_sse2_argb_no_surf_alpha(SDL_BlitInfo *info)
{
    ...
    */
    ...
    if (((width % 2) == 0) && ((srcskip % 2) == 0) && ((dstskip % 2) == 0)) {
        ...
        rgb_mask_128 = _mm_loadl_epi64((const __m128i *)&rgb_mask);
        offset_rgb_mask_128 =
            _mm_loadl_epi64((const __m128i *)&offset_rgb_mask);
            ...
            LOOP_UNROLLED4(
                {
                    ...
                    temp = _mm_add_epi16(mm_dst_alpha, temp);
                    *dstp64 =
                        (((Uint64)_mm_cvtsi128_si32(_mm_srli_si128(temp, 4)))
                             << 32 |
                         (Uint32)_mm_cvtsi128_si32(temp));
            ...
            LOOP_UNROLLED4(
                {
                    ...
                    sub_dst = _mm_packus_epi16(sub_dst, mm_zero);
                    /* reset alpha to 0 */
                    *dstp64 = (((Uint64)_mm_cvtsi128_si32(
                                   _mm_srli_si128(sub_dst, 4)))
                                   << 32 |
                               (Uint32)_mm_cvtsi128_si32(sub_dst)) &
                              rgb_mask64;
