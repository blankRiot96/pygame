...
#define DOC_PYGAMEGFXDRAWARC "arc(surface, x, y, r, start_angle, stop_angle, color) -> None\ndraw an arc"
#define DOC_PYGAMEGFXDRAWPIE "pie(surface, x, y, r, start_angle, stop_angle, color) -> None\ndraw a pie"
